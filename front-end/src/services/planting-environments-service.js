...
const insertPlantingEnvironment = async (plantingEnvironment) => {
  ...
  return await fetchPost(`api/planting-environment/insert`, plantingEnvironment, true);
};
...
const insertPlantingSpot = async (envId, plantingSpot) => {
  ...
  return await fetchPost(`api/planting-environment/${envId}/planting-spot/insert-update`, [plantingSpot], true);
};
...
export {insertPlantingEnvironment, getPlantingEnvironmentByUser, insertPlantingSpot}
